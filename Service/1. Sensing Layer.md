...
3.3. 피부 수분도 및 발한 지수 (Hydration & Sweat Index)정의: 피부 표면의 수분 함량 및 단위 시간당 땀 배출량입니다.측정 지표: THz 반사 계수의 진폭 변화 및 땀샘 공명 신호의 위상 변이입니다.바이오마커 가치: 선수의 탈수 임계점(체중의 2% 손실)을 예측하여 근육 경련 및 운동 능력 저하를 선제적으로 방어합니다.
3.4. 실시간 심부 체온 (Real-time Core Body Temperature)정의: 신체 내부 장기 및 혈액의 온도(Core Temp)입니다.측정 지표: TeraFET 검출기를 통해 포착된 $0.1$ ~ $1.5 \text{ THz}$ 광대역 방사 전압 신호입니다. 임계치 설정:주의: $38.5 \text{°C}$ 이상 (피로 급증, 주의력 저하)위험: $39.5 \text{°C}$ 이상 (열사병 징후, 즉각 중단 권고)바이오마커 가치: 외부 온도계가 감지하지 못하는 내부 열 축적을 감지하여 고온 환경에서의 급성 열사병을 예방합니다.
---
